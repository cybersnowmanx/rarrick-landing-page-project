    ...
    <section className="py-20 bg-gold">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map((b, i) => (
            <div key={i} className="rounded-xl border border-primary-foreground/15 p-6 hover:border-primary-foreground/30 transition-all group bg-secondary/10">
              <b.icon className="w-8 h-8 text-primary-foreground mb-4 group-hover:scale-110 transition-transform" />
